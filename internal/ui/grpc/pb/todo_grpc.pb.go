...
type TodoClient interface {
	ListTodo(ctx context.Context, in *TodoRequest, opts ...grpc.CallOption) (*TodoResponse, error)
}
...
func (c *todoClient) ListTodo(ctx context.Context, in *TodoRequest, opts ...grpc.CallOption) (*TodoResponse, error) {
	out := new(TodoResponse)
	err := c.cc.Invoke(ctx, "/pb.Todo/ListTodo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TodoServer interface {
	ListTodo(context.Context, *TodoRequest) (*TodoResponse, error)
...
func (UnimplementedTodoServer) ListTodo(context.Context, *TodoRequest) (*TodoResponse, error) {
...
func _Todo_ListTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Todo/ListTodo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServer).ListTodo(ctx, req.(*TodoRequest))
	}
